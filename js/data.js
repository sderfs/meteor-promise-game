...
const gameData = {
    ...
    "27": {
      ...
      data: {
        ...
        comments: [
          ...
          { user: "峡谷一枝花", text: "荒野之心论坛？里面有个ID挺有意思的，叫银鬃猫的最爱。👍156", bold: ["荒野之心"] },
          { user: "户外老猫（UP主）", text: "回复峡谷一枝花：对，那老哥写得不错。" },
          { user: "雨林路客", text: "我也记得那个ID。挺特别的。👍89" }
        ]
      }
    },
  ...
  hints: {
    ...
    "05": "八月有个标记。不是她的。",
    "06": "她常联系的人不多。就那几个。",
    "07": "有人约她看星星，有人嫌密码难记，有人问她吃没吃饭。",
    "08": "她买过一个箱子。评论区里她跟朋友说的话对得上。",
    "09": "没什么特别的。但她买东西的地方有个入口。",
    "10": "有一样东西她每月都买。还有几样不太像她会买的。",
    "11": "她来这里问过一个问题。答案留在了别的地方。",
    "12": "搜她的名字，两条结果。都和她第一本书有关。",
    "13": "一个日期。夏天。她不会忘的那种。",
    "14": "她笑着说了一句话。“最难忘的一天”。",
    "15": "那十一位。再加一个日子。",
    ...
    "20": "门锁着。钥匙在另一个地方。",
    "21": "微博小号的登录页。密码和她的生日有关。",
    "22": "原来每一篇都不是在编故事。",
    "23": "有一张照片上印着字。还有一张天空不太对劲。",
    "24": "一个普通的开箱视频。她也留言了。没什么特别的。",
    "25": "她的首页全是同一个主题。角落里有她看过的痕迹。",
    "26": "一列清单。最下面那个不太一样。",
    "27": "一个荒野求生视频。评论区里有人提到了另一个世界。",
    "28": "有人在这里说过一种记密码的方式。提到了一个果子。",
    "29": "搜那个地方。第一条就是。",
    "30": "有个帖子点不开。点发帖人的名字试试。",
    "31": "她说去采风。但带的东西像是要搬家。",
    "32": "两条路。先进她的，还是先看别人的。",
    "33": "荒野之心论坛的登录页。两个账号，选一个进去。",
    "34": "一共两篇。读完了就懂了。",
    "35": "该带的、该吃的、该说的。都在这篇里。",
    "36": "怎么准备、怎么稳住。评论区有人在开玩笑。",
    "37": "她的收藏全是实用帖。没发出去的那篇提到了天空。",
    "38": "那个地方改名了。新名字没写具体在哪。",
    "39": "新名字在阳光区。有个门牌号。",
    "40": "好几个门牌号。只有一个是对的。",
    "41": "六个数字。和她朋友空间里聊过的东西有关。",
    "42": "蛋糕店。她只看其中一类。",
    "43": "一份蛋糕店的菜单。整只蛋糕只有两款。名字像雾的那款藏着什么。",
    "44": "青苔巷。有人在那里消失过。监控拍到了蓝光。",
    "45": "巷子在老城区。有光。得先拿到那个小东西才能走。",
    "46": "藏在一个很亮的词后面。密码是一种甜的东西。"
  },
